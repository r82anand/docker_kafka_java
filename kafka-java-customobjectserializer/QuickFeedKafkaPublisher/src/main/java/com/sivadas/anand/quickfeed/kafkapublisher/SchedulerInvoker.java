 ...
 * 
 */
package com.sivadas.anand.quickfeed.kafkapublisher;
...
public class SchedulerInvoker implements CommandLineRunner {
	...
	/**
	 * The main method. Simple example shows how a command line spring
	 * application can execute an injected bean service. Also demonstrates how
	 * you can use @Value to inject command line args ('--name=whatever') or
